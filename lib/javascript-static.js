...
/* this is function that removes "0" in the begining of the string in the username - miki  */
function removeLeadingZero1(userName) {
 ...
 function removeLeadingZero2(userName) {
    var firstChar = userName.substr(0,1);
    while (firstChar=='0') {
        userName = userName.substr(1,userName.length-1);
